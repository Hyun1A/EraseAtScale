...
from src.engine.trainer_at_once import *
...
def main(args: argparse.Namespace) -> None:
    ...
    train_direct(config, args, prompts_available, tokenizer, text_encoder, unet, noise_scheduler, pipe, domain_map, amp_dtype=amp_dtype)
